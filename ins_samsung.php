            ...
            <main class="mdl-layout__content">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_InstallSetting_01.png" data-featherlight="imgs/samsung_InstallSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啟安裝外部APK</p>
                            1. 開啟設定中的 個人 / 鎖定螢幕與安全性。
                        </div>
                    </div>
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_InstallSetting_02.png" data-featherlight="imgs/samsung_InstallSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啟安裝外部APK</p>
                            2. 點擊開啟「未知的來源」（允許來自信任與未知來源的應用程式安裝）。
                        </div>
                    </div>
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_InstallSetting_03.png" data-featherlight="imgs/samsung_InstallSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啟安裝外部APK</p>
                ...
                <div class="xmind-content__posts mdl-grid">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_Install_01.png" data-featherlight="imgs/samsung_Install_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_Install_02.png" data-featherlight="imgs/samsung_Install_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_Install_03.png" data-featherlight="imgs/samsung_Install_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_Install_04.png" data-featherlight="imgs/samsung_Install_04.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                ...
                <div class="xmind-content__posts mdl-grid">
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_ServiceSetting_01.png" data-featherlight="imgs/samsung_ServiceSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_ServiceSetting_02.png" data-featherlight="imgs/samsung_ServiceSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_ServiceSetting_03.png" data-featherlight="imgs/samsung_ServiceSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_ServiceSetting_04.png" data-featherlight="imgs/samsung_ServiceSetting_04.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_ServiceSetting_05.png" data-featherlight="imgs/samsung_ServiceSetting_05.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                ...
                <div class="xmind-content__posts mdl-grid">
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_LocationSetting_01.png" data-featherlight="imgs/samsung_LocationSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_LocationSetting_02.png" data-featherlight="imgs/samsung_LocationSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/samsung_LocationSetting_03.png" data-featherlight="imgs/samsung_LocationSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
                            3. 若定位為「關閉」狀態，點擊右上角紅框中的開關將定位開啟，圖為已經開啟定位設定。
                        </div>
                    </div>
                </div>
                <div class="xmind-content__posts mdl-grid">
