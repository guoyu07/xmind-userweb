            ...
            <main class="mdl-layout__content">
                ...
                <div class="xmind-content__posts mdl-grid">
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_InstallSetting_01.png" data-featherlight="imgs/Sony_InstallSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_InstallSetting_02.png" data-featherlight="imgs/Sony_InstallSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啟安裝外部APK</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_InstallSetting_03.png" data-featherlight="imgs/Sony_InstallSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啟安裝外部APK</p>
                ...
                <div class="xmind-content__posts mdl-grid">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_Install_01.png" data-featherlight="imgs/Sony_Install_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_Install_02.png" data-featherlight="imgs/Sony_Install_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_Install_03.png" data-featherlight="imgs/Sony_Install_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_Install_04.png" data-featherlight="imgs/Sony_Install_04.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">下載與安裝 XMind 應用程式</p>
                ...
                <div class="xmind-content__posts mdl-grid">
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_ServiceSetting_01.png" data-featherlight="imgs/Sony_ServiceSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_ServiceSetting_02.png" data-featherlight="imgs/Sony_ServiceSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                            2. 在 協助工具 / 服務 / XMind 原本為「關閉」狀態，請點擊該項目。
                        </div>
                    </div>
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_ServiceSetting_03.png" data-featherlight="imgs/Sony_ServiceSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_ServiceSetting_04.png" data-featherlight="imgs/Sony_ServiceSetting_04.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_ServiceSetting_05.png" data-featherlight="imgs/Sony_ServiceSetting_05.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓協助工具服務設定</p>
                            5. 確認 無障礙設定 / 服務 / XMind 已經為「開啓」狀態。
                        </div>
                    </div>
                </div>
                <div class="xmind-content__posts mdl-grid">
                ...
                <div class="xmind-content__posts mdl-grid">
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_LocationSetting_01.png" data-featherlight="imgs/Sony_LocationSetting_01.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_LocationSetting_02.png" data-featherlight="imgs/Sony_LocationSetting_02.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_LocationSetting_03.png" data-featherlight="imgs/Sony_LocationSetting_03.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_LocationSetting_04.png" data-featherlight="imgs/Sony_LocationSetting_04.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
                    ...
                    <div class="mdl-card user-install-step mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--2dp">
                        <div class="mdl-card__title">
                            <div class="mobile-main_icon">
                                <img class="step-img image-lightbox" src="imgs/Sony_LocationSetting_05.png" data-featherlight="imgs/Sony_LocationSetting_05.png">
                            </div>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <p class="install_subject">開啓定位設定</p>
